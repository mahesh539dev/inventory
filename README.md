...
- **Public visitor** — sees a restricted view with product name, description, and notes.
- **Logged-in user** — sees the full internal product record (including cost, profit margin, and all internal notes).
